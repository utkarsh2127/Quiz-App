export default [
    ...
    {
      id: 'q9',
      text: 'In React.js, how we can pass the data from one component to another ?',
      answers: [
        'Props',
        'SetState',
    ...
    {
      id: 'q10',
      text: 'Which of the following function is true about changing the state in React.js ?',
      answers: [
        'this.setState{}',
        'this.State{}',
        'this.setChangeStateC{}',
        'All of the above',
      ],
    },
  ];